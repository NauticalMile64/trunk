...
class Law2_ScGeom_BubblePhys_Bubble : public LawFunctor{
	...
	YADE_CLASS_BASE_DOC_ATTRS_CTOR_PY(Law2_ScGeom_BubblePhys_Bubble,LawFunctor,"Constitutive law for Bubble model.",
		((Real,pctMaxForce,0.1,,"Percentage of the maximum allowable force. This dictates the point at which the force is reported from the artificial curve rather than the true curve."))
